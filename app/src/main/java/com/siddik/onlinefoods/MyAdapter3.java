...
public class MyAdapter3 extends RecyclerView.Adapter<FoodViewHolder>{

    private Context mContext;
    private List<FoodData> myFoodList;
    private int lastPosition = -1;

    public MyAdapter3(Context mContext, List<FoodData> myFoodList) {
    ...
    public void onBindViewHolder(@NonNull final FoodViewHolder foodViewHolder, int i) {
        ...
        foodViewHolder.mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(mContext,Confirm_Order.class);
